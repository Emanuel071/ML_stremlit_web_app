...
st.subheader('')
st.subheader('This project demonstrates how seemless and quick a recommendation can be made to the user much like how a recommendation is performed on a purchasing website such as Amazon, Apple, Temu and etc...')
st.subheader('')
